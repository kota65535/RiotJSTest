...
var _logdown = __webpack_require__(48);

var _logdown2 = _interopRequireDefault(_logdown);

var _sprintfJs = __webpack_require__(50);
...
function getLogger(name) {
    var logger = (0, _logdown2.default)(name);

    logger.printOpts = function (opts) {
        var ary = [];
...
_riot2.default.control = RiotControl;
...
_riot2.default.mixin('controlMixin', {
    onControl: function onControl(signal, func) {
        _riot2.default.control.on(signal, func);
        this.on('unmount', function () {
            return _riot2.default.control.off(signal, func);
        });
    }
});
...
var _GoogleAPIManager = __webpack_require__(15);
...
_riot2.default.control.on(_riot2.default.VE.APP.GOOGLE_API_LOADED, function () {
    log.info("Google API client loaded.");
});

window.onGoogleAPIClientLoad = function () {
    window.googleAPIManager = new _GoogleAPIManager.GoogleAPIManager(function (isAuthorized) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_riot_route__ = __webpack_require__(2);
...
__WEBPACK_IMPORTED_MODULE_1_riot___default.a.tag2('router', '<yield></yield>', '', '', function(opts) {
    ...
    this.route = __WEBPACK_IMPORTED_MODULE_0_riot_route__["default"].create();
    ...
    this.on('mount', function () {
      ...
      window.setTimeout(function () { return __WEBPACK_IMPORTED_MODULE_0_riot_route__["default"].start(true); }, 0);
    });
...
/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0_riot_route__["default"]);
...
exports.GoogleAPIManager = undefined;
...
var _GoogleAuthAPI = __webpack_require__(16);

var _GoogleDriveAPI = __webpack_require__(17);
...
var GoogleAPIManager = exports.GoogleAPIManager = function () {
    function GoogleAPIManager(onLoaded, onSignInStatusChanged) {
        _classCallCheck(this, GoogleAPIManager);

        this.authAPI = new _GoogleAuthAPI.GoogleAuthAPI(API_KEY, CLIENT_ID, SCOPE, DISCOVER_DOCS, this._onLoadedWrapper.bind(this), this._onSignInStatusChangedWrapper.bind(this));

        this.onLoaded = onLoaded;
        this.onSignInStatusChanged = onSignInStatusChanged;

        this.accessToken = null;
        this.driveAPI = new _GoogleDriveAPI.GoogleDriveAPI(API_KEY, null);
    ...
    _createClass(GoogleAPIManager, [{
        key: "signIn",
        value: function signIn(onSignedIn) {
        ...
        key: "showFilePicker",
        value: function showFilePicker(callback) {
            var _this = this;
        ...
        key: "showFolderPicker",
        value: function showFolderPicker(callback) {
            var _this2 = this;
            ...
            if (this.isSignedIn()) {
                ...
                this.signIn(function () {
                    _this2.driveAPI.showFolderPicker("root", callback);
                });
            }
        }
    }, {
        key: "getFilePath",
        value: function getFilePath(fileId) {
            return this.driveAPI.getFilePath(fileId);
        }
    }, {
        key: "createFile",
        value: function createFile(fileName, parents) {
            return this.driveAPI.createFile(fileName, "application/json", parents);
        }
    }, {
        key: "updateFile",
        value: function updateFile(fileId, content) {
        ...
        key: "_onLoadedWrapper",
        value: function _onLoadedWrapper(isSignedIn) {
            this._authorize();
            this.onLoaded(isSignedIn);
        }
    }, {
        key: "_onSignInStatusChangedWrapper",
        value: function _onSignInStatusChangedWrapper(isSignedIn) {
            this._authorize();
...
var GoogleDriveAPI = exports.GoogleDriveAPI = function () {
    ...
    _createClass(GoogleDriveAPI, [{
        ...
        key: 'showFolderPicker',
        value: function showFolderPicker(parents, callback) {
            var foldersOnlyView = new google.picker.DocsView(google.picker.ViewId.FOLDERS).setParent(parents) // これを付けないと全ての階層のフォルダが列挙される
            .setIncludeFolders(true).setSelectFolderEnabled(true);

            var pickerBuilder = new google.picker.PickerBuilder().enableFeature(google.picker.Feature.MINE_ONLY).enableFeature(google.picker.Feature.NAV_HIDDEN).addView(foldersOnlyView).setTitle('Select a folder').setOAuthToken(this.accessToken).setDeveloperKey(this.apiKey).setCallback(callback);
        ...
        key: 'showFilePicker',
        value: function showFilePicker(parents, callback) {
            // ファイルとフォルダー両方を表示し、ファイルの選択が可能なビュー
            var docsView = new google.picker.DocsView().setIncludeFolders(true);

            // ファイルとフォルダー両方の表示・選択が可能なビュー
            var docsAndFoldersView = new google.picker.DocsView().setIncludeFolders(true).setSelectFolderEnabled(true);

            if (parents) {
                docsView.setParent(parents);
            }

            var pickerBuilder = new google.picker.PickerBuilder().enableFeature(google.picker.Feature.MINE_ONLY).enableFeature(google.picker.Feature.NAV_HIDDEN)
            // .enableFeature(google.picker.Feature.MULTISELECT_ENABLED)
            .addView(docsView)
            // .addView(docsAndFoldersView)
            .setOAuthToken(this.accessToken).setDeveloperKey(this.apiKey).setCallback(callback);
        ...
        key: 'getFile',
        value: function getFile(fileId, fields) {
        ...
        value: function getFilePath(fileId) {
            ...
            var loop = function loop(fid, result) {
                return _this.getFile(fid, "id,name,parents").then(function (resp) {
            ...
            return new Promise(function (resolve, reject) {
                loop(fileId, titles).then(function () {
                    resolve(titles.join("/"));
                });
                // .catch(() => {
                //     reject();
        ...
        key: 'createFile',
        value: function createFile(fileName, mimeType, parents) {
            var metadata = {
        ...
        key: 'createFolder',
        value: function createFolder(folderName, parents) {
        ...
        value: function _makeRequest(method, url) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                xhr.open(method, url);
                xhr.setRequestHeader('Authorization', 'Bearer ' + _this2.accessToken);
...
this.links = [{ name: "Editor", url: "editor" }, { name: "Config", url: "config" }];

var highlightCurrent = function highlightCurrent(id) {
    _this.selectedId = id;
    _this.update();
};

(0, _riotRoute2.default)(highlightCurrent);
});
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    var riot = __webpack_require__(0)
    //src: src/tag/view-editor.tag
riot.tag2('view-editor',
  '<editor-nav is-authorized="{opts.isAuthorized}"></editor-nav> <editor-main></editor-main>',
  '',
  '', function(opts) {
"use strict";
...
this.on('mount', function () {
    log.info(_this.__.tagName + " is mounted.");
});
});
...
// module
exports.push([module.i, "@charset \"UTF-8\";\n/* Google PickerがModalダイアログの裏に隠れないようにする */\n.picker-dialog-bg {\n  z-index: 20000 !important; }\n\n.picker-dialog {\n  z-index: 20001 !important; }\n", ""]);
...
var LOCAL_STORAGE_KEY = "editor";

var EditorStore = exports.EditorStore = function (_StoreBase) {
    _inherits(EditorStore, _StoreBase);

    function EditorStore() {
        _classCallCheck(this, EditorStore);

        return _possibleConstructorReturn(this, (EditorStore.__proto__ || Object.getPrototypeOf(EditorStore)).call(this, LOCAL_STORAGE_KEY));
    }
    ...
    _createClass(EditorStore, [{
        ...
        value: function registerHandlers() {
            ...
            this.on(_riot2.default.VE.TEXT_CHANGED, function (text) {
                _this2.data["text"] = text;
                _this2.saveToStorage();
                _this2.trigger(_riot2.default.SE.TEXT_CHANGED, _this2.data["text"]);
            });
        }
    }]);
...
var StoreBase = exports.StoreBase = function () {
    function StoreBase(localStorageKey) {
        ...
        var json = window.localStorage.getItem(this.localStorageKey);
        if (!json) {
